...
public:
    ...
    void    setSearchParams(const double positionThreshold=-1, const double rotationThreshold=-1, const bool useWeightedClustering=true);

    void    trainM2E(std::vector<Eigen::Vector3f>& M_pc, std::vector<Eigen::Vector3f>& M_nr);

    void    matchM2E(std::vector<Eigen::Vector3f>& S_pc, std::vector<Eigen::Vector3f>& S_nr, 
